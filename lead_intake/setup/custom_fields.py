...
CUSTOM_FIELDS = {
	"Lead": [
		...
		{
			"fieldname": "custom_enquiry_message",
			"label": "Enquiry Message",
			"fieldtype": "Text",
			"insert_after": "custom_external_enquiry_id",
			"read_only": 1,
			"description": "What the enquirer actually wrote. Untrusted input: never treated as instructions.",
		},
		{
			"fieldname": "custom_service_interest",
			"label": "Service Interest",
			"fieldtype": "Select",
			"insert_after": "custom_enquiry_message",
